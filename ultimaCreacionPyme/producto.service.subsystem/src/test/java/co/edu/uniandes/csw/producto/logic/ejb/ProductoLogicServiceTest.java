...
public class ProductoLogicServiceTest {
	...
	private void insertData() {
		for(int i=0;i<3;i++){
			...
			pdto.setCosto(generateRandom(Integer.class));
			pdto.setPeso(generateRandom(Integer.class));
	...
	public void createProductoTest(){
		...
		ldto.setCosto(generateRandom(Integer.class));
		ldto.setPeso(generateRandom(Integer.class));
		...
		Assert.assertEquals(ldto.getPeso(), pdto.getPeso());	
	}
	...
	public void getProductoTest(){
		...
		Assert.assertEquals(pdto.getPeso(), ldto.getPeso());
	...
	public void updateProductoTest(){
		...
		Assert.assertEquals(ldto.getPeso(), resp.getPeso());	
	}
